    ...
    app.get('/', (req, res) => {
      res.send(`
        ...
        <html>
          <head>
            <meta charset="UTF-8">
            <title>Task 10.1P – Monitoring and Visibility</title>
            <style>
              body {
          ...
          <body>
           <div class="container">
              <h1>Task 10.1P – Monitoring and Visibility</h1>
               <h2>Cloud Native App Development | SIT323</h2>
               <p>This containerized microservice is deployed to a Google Kubernetes Engine (GKE) cluster and connected to a MongoDB database.</p>
                <p>Monitoring and logging are enabled using Google Cloud Monitoring and Logs Explorer to provide visibility into application performance.</p>
               <p>You can use the <code>/data</code> endpoints to perform CRUD operations on the MongoDB collection.</p>
              <div class="footer">
                <p>Created by Hope Russo | GKE Port: 80</p>
              </div> 
            </div>
          </body>
        </html>
